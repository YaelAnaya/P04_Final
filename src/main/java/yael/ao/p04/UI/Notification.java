...
/**
 * Esta clase crea un componente que muestra una notificación en diferentes partes de la pantalla.
 * @author yael
 * */
public class Notification extends javax.swing.JComponent {

    private JDialog dialog; // Ventana de la notificación.
    private Animator animator; // Animador de la notificación.
    private final Frame frame; // Frame en el que se crea la notificación.
    private boolean showing; // Indica si la notificación se está mostrando.
    private Thread thread; // Hilo de la notificación.
    private int animate = 10; // Velocidad de la animación.
    private BufferedImage imageShadow; // Imagen de la sombra.
    private int shadowSize = 6; // Tamaño de la sombra.
    private Type type; // Tipo de notificación.
    private Location location; // Localización de la notificación.
    ...
    public Notification(Frame fram, Type type, Location location, String message) {
        ...
        initComponents();
        init(message.toUpperCase());
        initAnimator();
    }
    /**
     * Este método inicializa el componente.
     * */
    ...
    private void initAnimator() {
        TimingTarget target = new TimingTargetAdapter() {
            ...
            /**
             * Este método calcula la posición de la notificación.
             * */
            ...
            /**
             * Este método inicializa la animación.
            * */
            public void begin() {
                if (!showing) {
            ...
            /**
             * Este método termina la animación.
             * */
            public void end() {
                showing = !showing;
                if (showing) {
    ...
    /**
     * Este método inicia la animación que muestra la notificación.
     * */
    public void showNotification() {
        animator.start();
    }
    /**
     * Este método inicia la animación que oculta la notificación.
     * */
    ...
    /**
     * Este método crea un delay de 2 segundos para que el usuario pueda leer la notificación.
     * */
    private void sleep() {
        try {
            Thread.sleep(2000);
    ...
    /**
     * Este método es el encargado de dibujar los componentes de la notificación.
     * */
    @Override
    ...
    /**
     * Enum para definir las diferentes posiciones en
     * las que se puede mostrar la notificación.
     * */
